...
vim.keymap.set("n", "<leader>o", "d$o<Esc>p==ko", { noremap = true, silent = true })
vim.keymap.set("n", "<leader>ss", "<cmd>lua vim.diagnostic.open_float()<CR>", { noremap = true, silent = true })
